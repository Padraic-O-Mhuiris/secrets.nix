...
#
{
  ...
  # Fixtures directory with real encrypted secrets (must be git-added)
...
in
  ...
  // lib.optionalAttrs (pkgs != null) {
    ...
    "test exists: _exists is true for git-tracked fixture" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
    ...
    "test exists: _path resolves to fixture path" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists: decrypt operation available for existing secret" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists: edit operation available for existing secret" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists: rotate operation available for existing secret" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists: rekey operation available for existing secret" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists: init NOT available for existing secret" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists: all operations for existing secret" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    # ===========================================================================
    # Existing Secret Derivation Tests (requires pkgs + fixtures)
    # ===========================================================================

    "test exists drv: decrypt has correct name" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists drv: edit has correct name" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists drv: rotate has correct name" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists drv: rekey has correct name" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    # ===========================================================================
    # Builder Pattern Tests for Existing Secrets (requires pkgs + fixtures)
    # ===========================================================================

    "test exists builder: decrypt has withSopsAgeKeyCmd" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists builder: decrypt has withSopsAgeKeyCmdPkg" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists builder: decrypt has buildSopsAgeKeyCmdPkg" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists builder: withSopsAgeKeyCmd returns derivation" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists builder: withSopsAgeKeyCmd preserves name" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists builder: chained builder preserves methods" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists builder: edit has builder methods" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists builder: rotate has builder methods" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists builder: rekey has builder methods" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    # ===========================================================================
    # mkSecretsPackages with Existing Secrets (requires pkgs + fixtures)
    # ===========================================================================

    "test exists packages: decrypt available in passthru" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists packages: all operations in passthru" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists packages: decrypt.recipient available with decryptPkg" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
    ...
    "test exists packages: decrypt.recipient.alice is derivation" = {
      expr = let
        secrets = mkSecrets {
          test-secret = {
            dir = fixturesSecretsDir;
